...
/** This is a class that contains all the information for a BurningShip object,
...
public class BurningShip extends FractalGenerator{
  ...
  display accoring to the function z_n = (|Re(z_(n-1))| + i|Im(z_(n-1))|)^2 + c
  ...
  public int numIterations(double re, double im) {
    ...
    while (i < MAX_ITERATIONS && z <= 4) {
      /** Taking absolute values of real and imaginary parts **/
      re = Math.abs(re);
      im = Math.abs(im);
